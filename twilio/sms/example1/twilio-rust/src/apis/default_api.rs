...
/// 
pub async fn create_address(configuration: &configuration::Configuration, account_sid: &str, city: &str, customer_name: &str, iso_country: &str, postal_code: &str, region: &str, street: &str, auto_correct_address: Option<bool>, emergency_enabled: Option<bool>, friendly_name: Option<&str>) -> Result<crate::models::ApiV2010AccountAddress, Error<CreateAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn create_application(configuration: &configuration::Configuration, account_sid: &str, api_version: Option<&str>, friendly_name: Option<&str>, message_status_callback: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_status_callback: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountApplication, Error<CreateApplicationError>> {
    let local_var_configuration = configuration;
...
pub async fn create_call(configuration: &configuration::Configuration, account_sid: &str, from: &str, to: &str, application_sid: Option<&str>, async_amd: Option<&str>, async_amd_status_callback: Option<&str>, async_amd_status_callback_method: Option<&str>, byoc: Option<&str>, call_reason: Option<&str>, call_token: Option<&str>, caller_id: Option<&str>, fallback_method: Option<&str>, fallback_url: Option<&str>, machine_detection: Option<&str>, machine_detection_silence_timeout: Option<i32>, machine_detection_speech_end_threshold: Option<i32>, machine_detection_speech_threshold: Option<i32>, machine_detection_timeout: Option<i32>, method: Option<&str>, record: Option<bool>, recording_channels: Option<&str>, recording_status_callback: Option<&str>, recording_status_callback_event: Option<Vec<String>>, recording_status_callback_method: Option<&str>, recording_track: Option<&str>, send_digits: Option<&str>, sip_auth_password: Option<&str>, sip_auth_username: Option<&str>, status_callback: Option<&str>, status_callback_event: Option<Vec<String>>, status_callback_method: Option<&str>, time_limit: Option<i32>, timeout: Option<i32>, trim: Option<&str>, twiml: Option<&str>, url: Option<&str>) -> Result<crate::models::ApiV2010AccountCall, Error<CreateCallError>> {
    let local_var_configuration = configuration;
...
pub async fn create_call_feedback_summary(configuration: &configuration::Configuration, account_sid: &str, end_date: String, start_date: String, include_subaccounts: Option<bool>, status_callback: Option<&str>, status_callback_method: Option<&str>) -> Result<crate::models::ApiV2010AccountCallCallFeedbackSummary, Error<CreateCallFeedbackSummaryError>> {
    let local_var_configuration = configuration;
...
pub async fn create_call_recording(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, recording_channels: Option<&str>, recording_status_callback: Option<&str>, recording_status_callback_event: Option<Vec<String>>, recording_status_callback_method: Option<&str>, recording_track: Option<&str>, trim: Option<&str>) -> Result<crate::models::ApiV2010AccountCallCallRecording, Error<CreateCallRecordingError>> {
    let local_var_configuration = configuration;
...
pub async fn create_incoming_phone_number(configuration: &configuration::Configuration, account_sid: &str, address_sid: Option<&str>, api_version: Option<&str>, area_code: Option<&str>, bundle_sid: Option<&str>, emergency_address_sid: Option<&str>, emergency_status: Option<&str>, friendly_name: Option<&str>, identity_sid: Option<&str>, phone_number: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, trunk_sid: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_receive_mode: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumber, Error<CreateIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_local(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, address_sid: Option<&str>, api_version: Option<&str>, bundle_sid: Option<&str>, emergency_address_sid: Option<&str>, emergency_status: Option<&str>, friendly_name: Option<&str>, identity_sid: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, trunk_sid: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_receive_mode: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal, Error<CreateIncomingPhoneNumberLocalError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_mobile(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, address_sid: Option<&str>, api_version: Option<&str>, bundle_sid: Option<&str>, emergency_address_sid: Option<&str>, emergency_status: Option<&str>, friendly_name: Option<&str>, identity_sid: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, trunk_sid: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_receive_mode: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile, Error<CreateIncomingPhoneNumberMobileError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_incoming_phone_number_toll_free(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, address_sid: Option<&str>, api_version: Option<&str>, bundle_sid: Option<&str>, emergency_address_sid: Option<&str>, emergency_status: Option<&str>, friendly_name: Option<&str>, identity_sid: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, trunk_sid: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_receive_mode: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree, Error<CreateIncomingPhoneNumberTollFreeError>> {
    let local_var_configuration = configuration;
...
pub async fn create_message(configuration: &configuration::Configuration, account_sid: &str, to: &str, address_retention: Option<&str>, application_sid: Option<&str>, attempt: Option<i32>, body: Option<&str>, content_retention: Option<&str>, force_delivery: Option<bool>, from: Option<&str>, max_price: Option<f32>, media_url: Option<Vec<String>>, messaging_service_sid: Option<&str>, persistent_action: Option<Vec<String>>, provide_feedback: Option<bool>, schedule_type: Option<&str>, send_as_mms: Option<bool>, send_at: Option<String>, smart_encoded: Option<bool>, status_callback: Option<&str>, validity_period: Option<i32>) -> Result<crate::models::ApiV2010AccountMessage, Error<CreateMessageError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_participant(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, from: &str, to: &str, beep: Option<&str>, byoc: Option<&str>, call_reason: Option<&str>, call_sid_to_coach: Option<&str>, caller_id: Option<&str>, coaching: Option<bool>, conference_record: Option<&str>, conference_recording_status_callback: Option<&str>, conference_recording_status_callback_event: Option<Vec<String>>, conference_recording_status_callback_method: Option<&str>, conference_status_callback: Option<&str>, conference_status_callback_event: Option<Vec<String>>, conference_status_callback_method: Option<&str>, conference_trim: Option<&str>, early_media: Option<bool>, end_conference_on_exit: Option<bool>, jitter_buffer_size: Option<&str>, label: Option<&str>, max_participants: Option<i32>, muted: Option<bool>, record: Option<bool>, recording_channels: Option<&str>, recording_status_callback: Option<&str>, recording_status_callback_event: Option<Vec<String>>, recording_status_callback_method: Option<&str>, recording_track: Option<&str>, region: Option<&str>, sip_auth_password: Option<&str>, sip_auth_username: Option<&str>, start_conference_on_enter: Option<bool>, status_callback: Option<&str>, status_callback_event: Option<Vec<String>>, status_callback_method: Option<&str>, time_limit: Option<i32>, timeout: Option<i32>, wait_method: Option<&str>, wait_url: Option<&str>) -> Result<crate::models::ApiV2010AccountConferenceParticipant, Error<CreateParticipantError>> {
    let local_var_configuration = configuration;
...
pub async fn create_sip_credential(configuration: &configuration::Configuration, account_sid: &str, credential_list_sid: &str, password: &str, username: &str) -> Result<crate::models::ApiV2010AccountSipSipCredentialListSipCredential, Error<CreateSipCredentialError>> {
    let local_var_configuration = configuration;
...
/// Create a new Domain
pub async fn create_sip_domain(configuration: &configuration::Configuration, account_sid: &str, domain_name: &str, byoc_trunk_sid: Option<&str>, emergency_caller_sid: Option<&str>, emergency_calling_enabled: Option<bool>, friendly_name: Option<&str>, secure: Option<bool>, sip_registration: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_status_callback_method: Option<&str>, voice_status_callback_url: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountSipSipDomain, Error<CreateSipDomainError>> {
    let local_var_configuration = configuration;
...
/// Create a Stream
pub async fn create_stream(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, url: &str, name: Option<&str>, parameter1_name: Option<&str>, parameter1_value: Option<&str>, parameter10_name: Option<&str>, parameter10_value: Option<&str>, parameter11_name: Option<&str>, parameter11_value: Option<&str>, parameter12_name: Option<&str>, parameter12_value: Option<&str>, parameter13_name: Option<&str>, parameter13_value: Option<&str>, parameter14_name: Option<&str>, parameter14_value: Option<&str>, parameter15_name: Option<&str>, parameter15_value: Option<&str>, parameter16_name: Option<&str>, parameter16_value: Option<&str>, parameter17_name: Option<&str>, parameter17_value: Option<&str>, parameter18_name: Option<&str>, parameter18_value: Option<&str>, parameter19_name: Option<&str>, parameter19_value: Option<&str>, parameter2_name: Option<&str>, parameter2_value: Option<&str>, parameter20_name: Option<&str>, parameter20_value: Option<&str>, parameter21_name: Option<&str>, parameter21_value: Option<&str>, parameter22_name: Option<&str>, parameter22_value: Option<&str>, parameter23_name: Option<&str>, parameter23_value: Option<&str>, parameter24_name: Option<&str>, parameter24_value: Option<&str>, parameter25_name: Option<&str>, parameter25_value: Option<&str>, parameter26_name: Option<&str>, parameter26_value: Option<&str>, parameter27_name: Option<&str>, parameter27_value: Option<&str>, parameter28_name: Option<&str>, parameter28_value: Option<&str>, parameter29_name: Option<&str>, parameter29_value: Option<&str>, parameter3_name: Option<&str>, parameter3_value: Option<&str>, parameter30_name: Option<&str>, parameter30_value: Option<&str>, parameter31_name: Option<&str>, parameter31_value: Option<&str>, parameter32_name: Option<&str>, parameter32_value: Option<&str>, parameter33_name: Option<&str>, parameter33_value: Option<&str>, parameter34_name: Option<&str>, parameter34_value: Option<&str>, parameter35_name: Option<&str>, parameter35_value: Option<&str>, parameter36_name: Option<&str>, parameter36_value: Option<&str>, parameter37_name: Option<&str>, parameter37_value: Option<&str>, parameter38_name: Option<&str>, parameter38_value: Option<&str>, parameter39_name: Option<&str>, parameter39_value: Option<&str>, parameter4_name: Option<&str>, parameter4_value: Option<&str>, parameter40_name: Option<&str>, parameter40_value: Option<&str>, parameter41_name: Option<&str>, parameter41_value: Option<&str>, parameter42_name: Option<&str>, parameter42_value: Option<&str>, parameter43_name: Option<&str>, parameter43_value: Option<&str>, parameter44_name: Option<&str>, parameter44_value: Option<&str>, parameter45_name: Option<&str>, parameter45_value: Option<&str>, parameter46_name: Option<&str>, parameter46_value: Option<&str>, parameter47_name: Option<&str>, parameter47_value: Option<&str>, parameter48_name: Option<&str>, parameter48_value: Option<&str>, parameter49_name: Option<&str>, parameter49_value: Option<&str>, parameter5_name: Option<&str>, parameter5_value: Option<&str>, parameter50_name: Option<&str>, parameter50_value: Option<&str>, parameter51_name: Option<&str>, parameter51_value: Option<&str>, parameter52_name: Option<&str>, parameter52_value: Option<&str>, parameter53_name: Option<&str>, parameter53_value: Option<&str>, parameter54_name: Option<&str>, parameter54_value: Option<&str>, parameter55_name: Option<&str>, parameter55_value: Option<&str>, parameter56_name: Option<&str>, parameter56_value: Option<&str>, parameter57_name: Option<&str>, parameter57_value: Option<&str>, parameter58_name: Option<&str>, parameter58_value: Option<&str>, parameter59_name: Option<&str>, parameter59_value: Option<&str>, parameter6_name: Option<&str>, parameter6_value: Option<&str>, parameter60_name: Option<&str>, parameter60_value: Option<&str>, parameter61_name: Option<&str>, parameter61_value: Option<&str>, parameter62_name: Option<&str>, parameter62_value: Option<&str>, parameter63_name: Option<&str>, parameter63_value: Option<&str>, parameter64_name: Option<&str>, parameter64_value: Option<&str>, parameter65_name: Option<&str>, parameter65_value: Option<&str>, parameter66_name: Option<&str>, parameter66_value: Option<&str>, parameter67_name: Option<&str>, parameter67_value: Option<&str>, parameter68_name: Option<&str>, parameter68_value: Option<&str>, parameter69_name: Option<&str>, parameter69_value: Option<&str>, parameter7_name: Option<&str>, parameter7_value: Option<&str>, parameter70_name: Option<&str>, parameter70_value: Option<&str>, parameter71_name: Option<&str>, parameter71_value: Option<&str>, parameter72_name: Option<&str>, parameter72_value: Option<&str>, parameter73_name: Option<&str>, parameter73_value: Option<&str>, parameter74_name: Option<&str>, parameter74_value: Option<&str>, parameter75_name: Option<&str>, parameter75_value: Option<&str>, parameter76_name: Option<&str>, parameter76_value: Option<&str>, parameter77_name: Option<&str>, parameter77_value: Option<&str>, parameter78_name: Option<&str>, parameter78_value: Option<&str>, parameter79_name: Option<&str>, parameter79_value: Option<&str>, parameter8_name: Option<&str>, parameter8_value: Option<&str>, parameter80_name: Option<&str>, parameter80_value: Option<&str>, parameter81_name: Option<&str>, parameter81_value: Option<&str>, parameter82_name: Option<&str>, parameter82_value: Option<&str>, parameter83_name: Option<&str>, parameter83_value: Option<&str>, parameter84_name: Option<&str>, parameter84_value: Option<&str>, parameter85_name: Option<&str>, parameter85_value: Option<&str>, parameter86_name: Option<&str>, parameter86_value: Option<&str>, parameter87_name: Option<&str>, parameter87_value: Option<&str>, parameter88_name: Option<&str>, parameter88_value: Option<&str>, parameter89_name: Option<&str>, parameter89_value: Option<&str>, parameter9_name: Option<&str>, parameter9_value: Option<&str>, parameter90_name: Option<&str>, parameter90_value: Option<&str>, parameter91_name: Option<&str>, parameter91_value: Option<&str>, parameter92_name: Option<&str>, parameter92_value: Option<&str>, parameter93_name: Option<&str>, parameter93_value: Option<&str>, parameter94_name: Option<&str>, parameter94_value: Option<&str>, parameter95_name: Option<&str>, parameter95_value: Option<&str>, parameter96_name: Option<&str>, parameter96_value: Option<&str>, parameter97_name: Option<&str>, parameter97_value: Option<&str>, parameter98_name: Option<&str>, parameter98_value: Option<&str>, parameter99_name: Option<&str>, parameter99_value: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, track: Option<&str>) -> Result<crate::models::ApiV2010AccountCallStream, Error<CreateStreamError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn create_validation_request(configuration: &configuration::Configuration, account_sid: &str, phone_number: &str, call_delay: Option<i32>, extension: Option<&str>, friendly_name: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>) -> Result<crate::models::ApiV2010AccountValidationRequest, Error<CreateValidationRequestError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_address(configuration: &configuration::Configuration, account_sid: &str, sid: &str, auto_correct_address: Option<bool>, city: Option<&str>, customer_name: Option<&str>, emergency_enabled: Option<bool>, friendly_name: Option<&str>, postal_code: Option<&str>, region: Option<&str>, street: Option<&str>) -> Result<crate::models::ApiV2010AccountAddress, Error<UpdateAddressError>> {
    let local_var_configuration = configuration;
...
pub async fn update_application(configuration: &configuration::Configuration, account_sid: &str, sid: &str, api_version: Option<&str>, friendly_name: Option<&str>, message_status_callback: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_status_callback: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountApplication, Error<UpdateApplicationError>> {
    let local_var_configuration = configuration;
...
pub async fn update_call(configuration: &configuration::Configuration, account_sid: &str, sid: &str, fallback_method: Option<&str>, fallback_url: Option<&str>, method: Option<&str>, status: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, time_limit: Option<i32>, twiml: Option<&str>, url: Option<&str>) -> Result<crate::models::ApiV2010AccountCall, Error<UpdateCallError>> {
    let local_var_configuration = configuration;
...
pub async fn update_call_feedback(configuration: &configuration::Configuration, account_sid: &str, call_sid: &str, issue: Option<Vec<String>>, quality_score: Option<i32>) -> Result<crate::models::ApiV2010AccountCallCallFeedback, Error<UpdateCallFeedbackError>> {
    let local_var_configuration = configuration;
...
/// 
pub async fn update_conference(configuration: &configuration::Configuration, account_sid: &str, sid: &str, announce_method: Option<&str>, announce_url: Option<&str>, status: Option<&str>) -> Result<crate::models::ApiV2010AccountConference, Error<UpdateConferenceError>> {
    let local_var_configuration = configuration;
...
pub async fn update_incoming_phone_number(configuration: &configuration::Configuration, account_sid: &str, sid: &str, account_sid2: Option<&str>, address_sid: Option<&str>, api_version: Option<&str>, bundle_sid: Option<&str>, emergency_address_sid: Option<&str>, emergency_status: Option<&str>, friendly_name: Option<&str>, identity_sid: Option<&str>, sms_application_sid: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>, status_callback: Option<&str>, status_callback_method: Option<&str>, trunk_sid: Option<&str>, voice_application_sid: Option<&str>, voice_caller_id_lookup: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_receive_mode: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountIncomingPhoneNumber, Error<UpdateIncomingPhoneNumberError>> {
    let local_var_configuration = configuration;
...
pub async fn update_participant(configuration: &configuration::Configuration, account_sid: &str, conference_sid: &str, call_sid: &str, announce_method: Option<&str>, announce_url: Option<&str>, beep_on_exit: Option<bool>, call_sid_to_coach: Option<&str>, coaching: Option<bool>, end_conference_on_exit: Option<bool>, hold: Option<bool>, hold_method: Option<&str>, hold_url: Option<&str>, muted: Option<bool>, wait_method: Option<&str>, wait_url: Option<&str>) -> Result<crate::models::ApiV2010AccountConferenceParticipant, Error<UpdateParticipantError>> {
    let local_var_configuration = configuration;
...
pub async fn update_short_code(configuration: &configuration::Configuration, account_sid: &str, sid: &str, api_version: Option<&str>, friendly_name: Option<&str>, sms_fallback_method: Option<&str>, sms_fallback_url: Option<&str>, sms_method: Option<&str>, sms_url: Option<&str>) -> Result<crate::models::ApiV2010AccountShortCode, Error<UpdateShortCodeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_domain(configuration: &configuration::Configuration, account_sid: &str, sid: &str, byoc_trunk_sid: Option<&str>, domain_name: Option<&str>, emergency_caller_sid: Option<&str>, emergency_calling_enabled: Option<bool>, friendly_name: Option<&str>, secure: Option<bool>, sip_registration: Option<bool>, voice_fallback_method: Option<&str>, voice_fallback_url: Option<&str>, voice_method: Option<&str>, voice_status_callback_method: Option<&str>, voice_status_callback_url: Option<&str>, voice_url: Option<&str>) -> Result<crate::models::ApiV2010AccountSipSipDomain, Error<UpdateSipDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn update_sip_ip_address(configuration: &configuration::Configuration, account_sid: &str, ip_access_control_list_sid: &str, sid: &str, cidr_prefix_length: Option<i32>, friendly_name: Option<&str>, ip_address: Option<&str>) -> Result<crate::models::ApiV2010AccountSipSipIpAccessControlListSipIpAddress, Error<UpdateSipIpAddressError>> {
    let local_var_configuration = configuration;
