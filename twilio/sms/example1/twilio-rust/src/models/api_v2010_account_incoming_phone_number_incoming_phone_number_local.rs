...
pub struct ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal {
    ...
    pub emergency_address_status: Option<EmergencyAddressStatus>,
...
/// State of the emergency address configuration for the phone number
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EmergencyAddressStatus {
...
impl Default for EmergencyAddressStatus {
    fn default() -> EmergencyAddressStatus {
        Self::Registered
    }
}
/// Displays if emergency calling is enabled for this number.
...
impl Default for VoiceReceiveMode {
    fn default() -> VoiceReceiveMode {
        Self::Voice
    }
}
